...
export const layout = (title: string, script: string) => html`
  <!DOCTYPE html>
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
    ...
    <body class="bg-gray-50 text-gray-800 font-sans leading-relaxed flex flex-col min-h-screen">
      ...
      <main class="container mx-auto px-4 pb-12 flex-grow flex items-center justify-center"><div id="entrypoint" /></main>
